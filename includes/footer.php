<div class="w-full bg-zinc-950 p-8">
    <div class="max-w-[1000px] m-auto">
        ...
        <a href='login.php' class="text-sm text-zinc-500">Login</a><span class="pl-3 pr-3 text-lg text-zinc-500">&bull;</span>
        <a href='register.php' class="text-sm text-zinc-500">Register</a><span
            class="pl-3 pr-3 text-lg text-zinc-500">&bull;</span>
