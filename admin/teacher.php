...
<?php if (isset($_SESSION['username'])) { } else { echo "<meta http-equiv=\" refresh\" content=\"0; url=index.php\">";
    exit();
    }
    ?>
    <!DOCTYPE html>
    ...
    <table class="table-auto mt-4 w-full bg-white">
        <thead>
            <tr class="bg-gray-950">
                ...
                <th class="px-4 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Question</th>
                <th class="px-4 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Action</th>
            </tr>
        </thead>
    ...
    <script>
        ...
        function loadQuestions() {
            ...
            xhr.open('GET', 'load_questions.php', true);
            xhr.onload = function() {
                if (this.status === 200) {
