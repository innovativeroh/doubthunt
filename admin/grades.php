            ...
            <div class="overflow-x-auto">
                ...
                <div id="popup" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
                    <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
                        ...
                        if (isset($_POST['addT'])) {
                            $value = @$_POST['value'];
                                $sql = "INSERT INTO `config_standards`(`id`, `value`) VALUES (null,'$value')";
                        ...
                        <form action="grades.php" method="POST">
                            <div class="mb-4">
                                <label for="valie" class="block text-gray-700">Standard (Name)</label>
                ...
                <div class="flex justify-between mb-4">
                    <h1 class="text-3xl font-semibold block mb-4 inline-block">Grades</h1>
                            ...
                            while ($rows = mysqli_fetch_assoc($query)) {
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <!-- <button
                                        ...
                                        <a href="delete_standard.php?id=<?=$subID?>"
